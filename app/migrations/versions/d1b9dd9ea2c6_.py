...
Revision ID: d1b9dd9ea2c6
Revises: 270bb262766e
Create Date: 2026-02-04 12:14:43.976090
...
revision: str = "d1b9dd9ea2c6"
down_revision: Union[str, Sequence[str], None] = "270bb262766e"
...
def upgrade():
    ...
    # Вставка данных в orders_products
    op.execute("""
...
def downgrade() -> None:
    """Downgrade schema."""
    op.execute("DELETE FROM orders_products")
